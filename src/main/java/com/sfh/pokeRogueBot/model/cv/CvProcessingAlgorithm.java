...
public class CvProcessingAlgorithm {
    ...
    private CvProcessingAlgorithm(int algorithm, double threshHold, CvFilterType filterType, String name) {
     ...
     */
    public static final CvProcessingAlgorithm TM_CCOEFF_NORMED = new CvProcessingAlgorithm(Imgproc.TM_CCOEFF_NORMED, 0.8, CvFilterType.HIGHEST_Result, "TM_CCOEFF_NORMED");
     ...
     * Threshold: 0.8 oder höher (höher ist besser)
     */
    public static final CvProcessingAlgorithm TM_CCORR_NORMED = new CvProcessingAlgorithm(Imgproc.TM_CCORR_NORMED, 0.8, CvFilterType.HIGHEST_Result, "TM_CCORR_NORMED");
     ...
     */
    public static final CvProcessingAlgorithm TM_SQDIFF = new CvProcessingAlgorithm(Imgproc.TM_SQDIFF, 0.1, CvFilterType.LOWEST_Result, "TM_SQDIFF");
     ...
     * Threshold: 0.1 oder niedriger (niedriger ist besser)
     */
    public static final CvProcessingAlgorithm TM_SQDIFF_NORMED = new CvProcessingAlgorithm(Imgproc.TM_SQDIFF_NORMED, 0.1, CvFilterType.LOWEST_Result, "TM_SQDIFF_NORMED");
     ...
     * Threshold: 0.8 oder höher (höher ist besser)
     */
    public static final CvProcessingAlgorithm TM_CCORR = new CvProcessingAlgorithm(Imgproc.TM_CCORR, 0.8, CvFilterType.HIGHEST_Result, "TM_CCORR");
     ...
     * Threshold: 0.8 oder höher (höher ist besser)
     */
    public static final CvProcessingAlgorithm TM_CCOEFF = new CvProcessingAlgorithm(Imgproc.TM_CCOEFF, 0.8, CvFilterType.HIGHEST_Result, "TM_CCOEFF");
